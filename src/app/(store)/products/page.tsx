...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return settings.success ? storeMetadata(settings.data, { title: `Products | ${settings.data.name}`, description: `Shop active products from ${settings.data.name}.`, alternates: { canonical: "/products" } }) : {};
}
