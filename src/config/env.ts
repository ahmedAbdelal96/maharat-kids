...
export const envSchema = z.object({
  ...
  CUSTOMER_OTP_SMS_PROVIDER: optionalEnvString(),
  CUSTOMER_OTP_SMS_API_URL: optionalEnvString(),
  CUSTOMER_OTP_SMS_API_KEY: optionalEnvString(),
  CUSTOMER_OTP_EMAIL_PROVIDER: optionalEnvString(),
  CUSTOMER_OTP_EMAIL_API_URL: optionalEnvString(),
  CUSTOMER_OTP_EMAIL_API_KEY: optionalEnvString(),
