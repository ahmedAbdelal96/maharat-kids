import type { OrderStatus, PaymentStatus, ShipmentStatus, PaymentMethodType } from "@prisma/client";
import type { OrderFulfillment } from "./domain/rules";
...
export type OrderItem = { id: string; productId: string; variantId: string | null; variantSku?: string | null; variantOptions?: unknown; name: string; imageUrl: string | null; unitPrice: string; quantity: number; lineTotal: string; isPromotionGift: boolean; promotionId?: string | null; fulfillmentTypeSnapshot?: "PHYSICAL" | "DIGITAL"; digitalAssetIdsSnapshot?: unknown };
...
export type CheckoutData = {
  ...
  fulfillment: "PHYSICAL_ONLY" | "DIGITAL_ONLY" | "MIXED";
};
